			...
			<div class="selectShop">
				<ul>
					<li>
						...
						<p>荷包口红•豇豆红</p>
						<span class="newPrice">￥199.00</span><span class="notice">上新价</span>
					</li>
					<li>
						<img src="../../assets/selectShop2.png" />
						<p>鹤禧觉色•气垫</p>
						<span class="newPrice">￥120.00</span><span class="oldPrice">￥199</span>
					</li>
					<li>
						<img src="../../assets/selectShop3.png" />
						<p>鹤禧觉色•气垫</p>
						<span class="newPrice">￥540.00</span><span class="notice">限时</span>
					</li>
					<li>
						<img src="../../assets/selectShop4.png" />
						<p>鹤舞青松丝巾</p>
						<span class="newPrice">￥120.00</span><span class="notice">上新价</span>
					</li>
				</ul>
			</div>
